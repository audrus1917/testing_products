...
+ [ ] Необходимо хранить данные о категориях товара, при этом сами категории могут иметь 
...
* [ ] Проанализировать написанный в п. 2.3.1 запрос и структуру БД. Предложить варианты оптимизации 
      этого запроса и общей схемы данных для повышения производительности системы в 
      условиях роста данных (тысячи заказов в день).
* [ ] Написать сервис «Добавление товара в заказ» который работает по REST-API. Метод должен принимать ID заказа, 
...
* cсылка на репозиторий с тестовым заданием
* ссылка на схему БД
* ссылка на дамп с простым случайным набором данных
* ссылка на скрипт для заполнения этими данными
